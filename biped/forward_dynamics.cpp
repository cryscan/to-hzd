    ...
    const ExtForces& fext/* = zeroExtForces */)
{
    ...
    compute_Ia_revolute(R_shin_AI, R_shin_U, R_shin_D, Ia_r);  // same as: Ia_r = R_shin_AI - R_shin_U/R_shin_D * R_shin_U.transpose();
    ...
    compute_Ia_revolute(R_thigh_AI, R_thigh_U, R_thigh_D, Ia_r);  // same as: Ia_r = R_thigh_AI - R_thigh_U/R_thigh_D * R_thigh_U.transpose();
    ...
    compute_Ia_revolute(R_hip_AI, R_hip_U, R_hip_D, Ia_r);  // same as: Ia_r = R_hip_AI - R_hip_U/R_hip_D * R_hip_U.transpose();
    ...
    compute_Ia_revolute(L_shin_AI, L_shin_U, L_shin_D, Ia_r);  // same as: Ia_r = L_shin_AI - L_shin_U/L_shin_D * L_shin_U.transpose();
    ...
    compute_Ia_revolute(L_thigh_AI, L_thigh_U, L_thigh_D, Ia_r);  // same as: Ia_r = L_thigh_AI - L_thigh_U/L_thigh_D * L_thigh_U.transpose();
    ...
    compute_Ia_revolute(L_hip_AI, L_hip_U, L_hip_D, Ia_r);  // same as: Ia_r = L_hip_AI - L_hip_U/L_hip_D * L_hip_U.transpose();
