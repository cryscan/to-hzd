...
Biped::rcg::InertiaProperties::InertiaProperties()
{
    ...
    tensor_L_thigh.fill(
        m_L_thigh,
        com_L_thigh,
        Utils::buildInertiaTensor<Scalar>(ix_L_thigh,iy_L_thigh,iz_L_thigh,ixy_L_thigh,ixz_L_thigh,iyz_L_thigh) );
    ...
    tensor_R_thigh.fill(
        m_R_thigh,
        com_R_thigh,
        Utils::buildInertiaTensor<Scalar>(ix_R_thigh,iy_R_thigh,iz_R_thigh,ixy_R_thigh,ixz_R_thigh,iyz_R_thigh) );
