...
const Biped::rcg::Jacobians::Type_fr_trunk_J_L_foot& Biped::rcg::Jacobians::Type_fr_trunk_J_L_foot::update(const JointState& q)
{
    ...
    (*this)(2,1) = -sin_q_L_HAA;
    (*this)(2,2) = -sin_q_L_HAA;
    (*this)(3,1) = ( tx_L_foot * sin_q_L_HFE * sin_q_L_KFE)-( tx_L_foot * cos_q_L_HFE * cos_q_L_KFE)-( tx_L_KFE * cos_q_L_HFE);
    (*this)(3,2) = ( tx_L_foot * sin_q_L_HFE * sin_q_L_KFE)-( tx_L_foot * cos_q_L_HFE * cos_q_L_KFE);
    (*this)(4,0) = ( tx_L_foot * cos_q_L_HAA * sin_q_L_HFE * sin_q_L_KFE)-( tx_L_foot * cos_q_L_HAA * cos_q_L_HFE * cos_q_L_KFE)-( tx_L_KFE * cos_q_L_HAA * cos_q_L_HFE)-( tx_L_HFE * cos_q_L_HAA);
    ...
    (*this)(4,2) = ( tx_L_foot * sin_q_L_HAA * cos_q_L_HFE * sin_q_L_KFE)+( tx_L_foot * sin_q_L_HAA * sin_q_L_HFE * cos_q_L_KFE);
    (*this)(5,0) = (- tx_L_foot * sin_q_L_HAA * sin_q_L_HFE * sin_q_L_KFE)+( tx_L_foot * sin_q_L_HAA * cos_q_L_HFE * cos_q_L_KFE)+( tx_L_KFE * sin_q_L_HAA * cos_q_L_HFE)+( tx_L_HFE * sin_q_L_HAA);
    ...
    (*this)(5,2) = ( tx_L_foot * cos_q_L_HAA * cos_q_L_HFE * sin_q_L_KFE)+( tx_L_foot * cos_q_L_HAA * sin_q_L_HFE * cos_q_L_KFE);
    return *this;
}
...
const Biped::rcg::Jacobians::Type_fr_trunk_J_R_foot& Biped::rcg::Jacobians::Type_fr_trunk_J_R_foot::update(const JointState& q)
{
    ...
    (*this)(2,1) = sin_q_R_HAA;
    (*this)(2,2) = sin_q_R_HAA;
    (*this)(3,1) = ( tx_R_foot * sin_q_R_HFE * sin_q_R_KFE)-( tx_R_foot * cos_q_R_HFE * cos_q_R_KFE)-( tx_R_KFE * cos_q_R_HFE);
    (*this)(3,2) = ( tx_R_foot * sin_q_R_HFE * sin_q_R_KFE)-( tx_R_foot * cos_q_R_HFE * cos_q_R_KFE);
    (*this)(4,0) = (- tx_R_foot * cos_q_R_HAA * sin_q_R_HFE * sin_q_R_KFE)+( tx_R_foot * cos_q_R_HAA * cos_q_R_HFE * cos_q_R_KFE)+( tx_R_KFE * cos_q_R_HAA * cos_q_R_HFE)+( tx_R_HFE * cos_q_R_HAA);
    ...
    (*this)(4,2) = (- tx_R_foot * sin_q_R_HAA * cos_q_R_HFE * sin_q_R_KFE)-( tx_R_foot * sin_q_R_HAA * sin_q_R_HFE * cos_q_R_KFE);
    (*this)(5,0) = (- tx_R_foot * sin_q_R_HAA * sin_q_R_HFE * sin_q_R_KFE)+( tx_R_foot * sin_q_R_HAA * cos_q_R_HFE * cos_q_R_KFE)+( tx_R_KFE * sin_q_R_HAA * cos_q_R_HFE)+( tx_R_HFE * sin_q_R_HAA);
    ...
    (*this)(5,2) = ( tx_R_foot * cos_q_R_HAA * cos_q_R_HFE * sin_q_R_KFE)+( tx_R_foot * cos_q_R_HAA * sin_q_R_HFE * cos_q_R_KFE);
    return *this;
}
